   ...
   <header><h1> Attendence Management System</h1></header>
       <div class="container">
        <div class="card card-container">
		     <h3 class="profile-name-card"> <u>Admin Login</u></h3>
            <img id="profile-img" class="profile-img-card" src="img/avatar_2x.png" />
            <p id="profile-name" class="profile-name-card"></p>
            <form class="form-signin" action="adminlogin_process.php" method="post">
                ...
                <input type="password" id="inputPassword"  name="password" maxlength='10' class="form-control" placeholder="Password" required>
